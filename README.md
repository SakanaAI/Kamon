...
A set of 10,000 synthetic examples generated by synthetic_examples.py, along with parses and translations can be found in the `synthetic_examples` subdirectory.
