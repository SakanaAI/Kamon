...
A set of 10,000 synthetic examples generated by `synthetic_examples.py`, along
with parses and translations can be found in `synthetic_examples_01.zip` and `synthetic_examples_02.zip`.
